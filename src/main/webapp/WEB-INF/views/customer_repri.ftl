...
<div id="p" class="easyui-panel" title="客户流失信息" style="height:250px">
    <table cellspacing="8px">
        ...
        <tr>
            ...
            <td>    </td>
            <td>上次下单时间：</td>
            <td><input type="text" id="lastOrderTime" name="lastOrderTime" readonly="readonly" value="${(customerLoss['lastOrderTimeStr'])!}"/></td>
        </tr>
        <tr>
            <td>确认流失时间：</td>
            <td><input type="text" id="confirmLossTime" name="confirmLossTime" readonly="readonly" value="${(customerLoss['confirmLossTimeStr'])!}"/></td>
            <td colspan="3">    </td>
        </tr>
        <tr>
            <td>流失原因：</td>
